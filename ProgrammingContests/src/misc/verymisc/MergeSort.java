...
public class MergeSort {
     ...
     **/
    public static void recursiveSort(Integer[] elements, Comparator<Integer> comp) {
        rSort(elements, comp, 0, elements.length);
    }

    public static void rSort(Integer[] elements, Comparator<Integer> comp, int start, int end) {
        if (end - start > 1) {
            int mid = (start + end) / 2;
