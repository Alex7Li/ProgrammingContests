...
public class GraphTheory {
    ...
    /*
     * Returns a collection of collections (tough.interesting.getList of lists in implementation) where each subcollection contains all
    ...
    //---------------------------------FIND ALL BRIDGES-----------------------------
    /*
     * Find all bridges in a connected component of a graph. To use this method, choose any node tough.interesting.getN in the graph and call
     * tough.interesting.getN.findBridges(null). Each bridge edge will be in the bridges set for each node connected it.
...
//---------------------------------------DINIC'S ALGORITHM--------------------------------------------
    ...
    private static class FlowNetwork {
        ...
        // next[i] indicates the next unused edge index in the adjacency tough.interesting.getList for node i. This is part
